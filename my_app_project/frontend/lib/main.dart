  ...
  'elements': [
    {
      ...
      'videoUrl': '',
      'imageUrls': [
        'https://picsum.photos/id/986/800/400',
        'https://picsum.photos/id/793/800/400',
        'https://picsum.photos/id/689/800/400',
      ],
      'icon': 'star',
      'bold': false,
      'italic': false,
            ...
            child: Container(
              ...
              child: Opacity(
                ...
                child: ImageSliderWidget(
                  imageUrls: ['https://picsum.photos/id/986/800/400', 'https://picsum.photos/id/793/800/400', 'https://picsum.photos/id/689/800/400'],
                  height: 200,
                ),
              ),
            ),
                      ...
                      child: Padding(
                        ...
                        child: Card(
                          ...
                          child: Column(
                            ...
                            children: [
                              Image.network('https://picsum.photos/id/3/200/300', fit: BoxFit.cover, height: 100),
                              Padding(
                                padding: const EdgeInsets.all(8),
                                child: Text('Title 1', style: GoogleFonts.getFont(
  'Poppins',
  fontSize: 20,
  color: Color(0x000000),
)
.copyWith(fontWeight: FontWeight.bold), textAlign: TextAlign.left),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(8),
                                child: Text('Subtitle 1', style: GoogleFonts.getFont(
  'Poppins',
  fontSize: 20,
  color: Color(0x000000),
)
                      ...
                      child: Padding(
                        ...
                        child: Card(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: [
                              Image.network('https://picsum.photos/id/327/200/300', fit: BoxFit.cover, height: 100),
                              Padding(
                                padding: const EdgeInsets.all(8),
                                child: Text('Title 2', style: GoogleFonts.getFont(
  'Poppins',
  fontSize: 20,
  color: Color(0x000000),
)
.copyWith(fontWeight: FontWeight.bold), textAlign: TextAlign.left),
                              ...
                              Padding(
                                padding: const EdgeInsets.all(8),
                                child: Text('Subtitle 2', style: GoogleFonts.getFont(
  'Poppins',
  fontSize: 20,
  color: Color(0x000000),
)
                      ...
                      child: Padding(
                        ...
                        child: Card(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: [
                              Image.network('https://picsum.photos/id/443/200/300', fit: BoxFit.cover, height: 100),
                              Padding(
                                padding: const EdgeInsets.all(8),
                                child: Text('Title 3', style: GoogleFonts.getFont(
  'Poppins',
  fontSize: 20,
  color: Color(0x000000),
)
.copyWith(fontWeight: FontWeight.bold), textAlign: TextAlign.left),
                              ...
                              Padding(
                                padding: const EdgeInsets.all(8),
                                child: Text('Subtitle 3', style: GoogleFonts.getFont(
  'Poppins',
  fontSize: 20,
  color: Color(0x000000),
)
...
,
            ...
            child: Container(
              ...
              child: Opacity(
                opacity: 1,
                child: TextField(
                  controller: _controllers['field_1756451136225'],
            ...
            child: Container(
              ...
              child: Opacity(
                opacity: 1,
                child: TextField(
                  controller: _controllers['field_1756451137085'],
                  decoration: InputDecoration(
                    labelText: 'null',
                    hintText: 'null',
                    border: OutlineInputBorder(),
            ...
            child: Container(
              ...
              child: Opacity(
                opacity: 1,
                child: TextField(
                  controller: _controllers['field_1756451138894'],
                  decoration: InputDecoration(
                    labelText: 'null',
                    hintText: 'null',
                    border: OutlineInputBorder(),
